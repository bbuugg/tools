...
请在 PR 或 issue 中说明你的修改。如需对外发布、二次发行或商业使用，请遵守项目的 LICENSE（如仓库中未包含 LICENSE，请在发布前补充授权说明）。

---

如果你希望我把 README 再精简为英文版、或把每个工具生成更加详细的使用文档（含截图、输入/输出示例、常见故障及解决办法），告诉我想要的格式，我可以继续生成对应的文档或单独的 `docs/` 文件。

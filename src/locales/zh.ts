export default {
  ...
  tools: {
    videoImageConverter: {
      title: '视频/图片转换器',
      description: '将视频转换为图片（PNG、JPG、WebP）或将图片制作成视频（可添加音频）',
      howToUse: {
        title: '使用方法',
        step1: '选择转换模式：视频转图片或图片转视频',
        step2: '上传您的文件（视频或图片）',
        step3: '配置设置（帧间隔、图片格式、持续时间等）',
        step4: '处理并下载结果',
      },
      mode: {
        title: '转换模式',
        videoToImage: '视频转图片',
        videoToImageDesc: '从视频中提取帧作为单独的图片',
        imageToVideo: '图片转视频',
        imageToVideoDesc: '从图片创建带可选音频的视频幻灯片',
      },
      videoToImage: {
        title: '视频转图片',
        dragDrop: '将视频文件拖拽到这里或点击选择',
        selectFile: '选择视频文件',
        supportedFormats: '支持 MP4、MOV、AVI、WMV 等视频格式',
        settings: {
          frameInterval: '帧间隔',
          frameIntervalDesc: '每 X 秒提取一帧',
          imageFormat: '图片格式',
          quality: '图片质量',
        },
        preview: '视频预览',
      ...
      imageToVideo: {
        title: '图片转视频',
        dragDrop: '将图片文件拖拽到这里或点击选择',
        selectFiles: '选择图片文件',
        supportedFormats: '支持 JPG、PNG、WebP 等图片格式',
        selectedImages: '已选择的图片',
        audio: {
          title: '添加音频（可选）',
          dragDrop: '将音频文件拖拽到这里或点击选择',
          selectFile: '选择音频文件',
          supportedFormats: '支持 MP3、WAV、AAC 等音频格式',
        },
        settings: {
          title: '视频设置',
          durationPerImage: '每张图片时长',
          durationPerImageDesc: '每张图片显示的时长',
          transition: '过渡效果',
          transitions: {
            none: '无',
            fade: '淡入淡出',
      ...
      messages: {
        videoLoaded: '视频加载成功！',
        imagesLoaded: '成功加载 {count} 张图片！',
        audioLoaded: '音频加载成功！',
        framesExtracted: '成功提取 {count} 帧！',
      ...
      errors: {
        ...
        noValidImages: '未选择有效的图片文件。',
        noVideoSelected: '请先选择一个视频文件。',
        noImagesSelected: '请至少选择一张图片文件。',
        processingFailed: '处理失败',
      },
      tips: {
        title: '提示',
        tip1: '为获得更好的效果，请使用光照一致、画面清晰的视频',
        tip2: '制作视频时，请使用尺寸相似的图片',
        tip3: '添加音频可以显著提升视频幻灯片的效果',
      },
    },
    wsTool: {
      title: 'WebSocket 工具',
      ...
      closedStatus: '连接关闭',
      serverAddress: '服务地址',
      addressPlaceholder: '输入不带前缀的服务器地址',
      openConnection: '开启连接',
      ...
      stopSend: '停止发送',
      manualSend: '手动发送',
      sendPlaceholder: '需要发送到服务端的内容',
      clearAfterSend: '发包清空输入',
      sendToServer: '发送到服务端',
      debugMessages: '调试消息',
      noDebugMessages: '暂无调试消息',
      messageHistory: '消息记录',
      clearMessages: '清空消息',
      clearAfterReceive: '收包清空记录',
      jsonDecode: '收包JSON解码',
      pauseReceive: '暂停接收',
      noMessages: '暂无消息。连接到 WebSocket 服务器并发送消息。',
      sent: '已发送',
      received: '收到',
      initSuccess: '初始化完成',
      browserNotSupport: '当前浏览器不支持 H5 WebSocket 请更换浏览器',
      opened: '已开启',
      closed: '已关闭',
      errorOccurred: '发生错误 请打开浏览器控制台查看',
      createWsFailed: '创建 WebSocket 对象失败 请检查服务器地址',
      loopSend: '循环发送',
      sendFailed: '消息发送失败 原因请查看控制台',
    },
    htmlExtractor: {
      title: 'HTML 内容提取器',
    ...
    jwtTool: {
      title: 'JWT 工具',
      description: '编码、解码和验证 JSON Web 令牌，支持自定义算法',
      encodeTab: '编码',
      decodeTab: '解码',
      verifyTab: '验证',
      features: {
        encode: {
          title: '令牌编码',
          description: '使用自定义头部、载荷和签名密钥创建 JWT 令牌',
        },
        decode: {
          title: '令牌解码',
          description: '解码 JWT 令牌以查看头部和载荷信息并进行验证',
        },
        verify: {
          title: '签名验证',
          description: '验证 JWT 令牌的签名以确保真实性和完整性',
        },
      },
      encode: {
        header: '头部',
      ...
      decode: {
        tokenInput: '令牌输入',
        tokenPlaceholder: '在此粘贴您的 JWT 令牌...',
      ...
      messages: {
        ...
        tokenDownloaded: '令牌下载成功！',
        validToken: '有效的令牌签名',
        expiredToken: '令牌已过期',
        notBeforeToken: '令牌尚未生效',
        invalidToken: '无效的令牌格式',
        validSignature: '有效签名',

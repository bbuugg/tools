export default {
  ...
  tools: {
    ...
    fileRenamer: {
      title: '批量文件重命名工具',
      description: '功能强大的批量文件重命名工具，支持多种模式和本地处理',
      uploadSection: '上传文件',
      uploadTitle: '拖放文件或点击选择',
      uploadDescription: '选择多个文件进行批量重命名',
      selectFiles: '选择文件',
      fileList: '文件列表',
      preview: '预览',
      apply: '应用',
      ...
      features: {
        batch: {
          title: '批量处理',
          description: '一次性重命名数百个文件，具有强大的模式匹配和转换工具。',
        },
        privacy: {
          title: '隐私保护',
          description: '所有处理都在您的浏览器本地进行。文件永远不会上传到任何服务器。',
        },
        flexible: {
          title: '灵活选项',
          description: '多种重命名模式可以组合使用，实现复杂的文件名转换。',
        },
      },
      success: {
        filesAdded: '成功添加 {count} 个文件！',
        previewGenerated: '预览生成成功！',
        renameComplete: '文件重命名成功！',
        downloadComplete: '下载完成！',
      },
      errors: {
        downloadFailed: '下载文件失败',

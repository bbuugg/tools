export default {
  ...
  tools: {
    ...
    heartCollage: {
      ...
      images: '图片',
      generating: '生成中...',
      generateCollage: '生成拼贴',
      downloadCollage: '下载拼贴',
      previewPlaceholder: '生成后预览将显示在此处',
      collageSize: '拼贴大小',
      selectedImages: '已选图片',
      features: {
        collage: {
        ...
        customization: {
          title: '自定义选项',
          description: '自定义画布大小、图片形状、间距等',
        },
        export: {
          title: '导出结果',
          description: '将心形拼贴下载为高质量PNG图片',
        },
      },
      messages: {
        filesAdded: '成功添加 {count} 个文件',
        collageGenerated: '心形拼贴生成成功！',
      ...
      errors: {
        ...
        noImagesSelected: '请至少选择一张图片来生成拼贴',
        generationFailed: '生成心形拼贴失败',

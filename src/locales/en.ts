export default {
  ...
  tools: {
    videoImageConverter: {
      ...
      description:
        'Convert videos to images (PNG, JPG, WebP) or create videos from images with optional audio',
      howToUse: {
        title: 'How to Use',
        step1: 'Select conversion mode: Video to Images or Images to Video',
        step2: 'Upload your files (video or images)',
        step3: 'Configure settings (frame interval, image format, duration, etc.)',
        step4: 'Process and download the results',
      },
      mode: {
        title: 'Conversion Mode',
        videoToImage: 'Video to Images',
        videoToImageDesc: 'Extract frames from a video as individual images',
        imageToVideo: 'Images to Video',
        imageToVideoDesc: 'Create a video slideshow from images with optional audio',
      },
      videoToImage: {
        title: 'Video to Images',
        dragDrop: 'Drag & drop a video file here or click to select',
        selectFile: 'Select Video File',
        supportedFormats: 'Supports MP4, MOV, AVI, WMV, and other video formats',
        settings: {
          frameInterval: 'Frame Interval',
          frameIntervalDesc: 'Extract one frame every X seconds',
      ...
      imageToVideo: {
        ...
        dragDrop: 'Drag & drop image files here or click to select',
        ...
        audio: {
          ...
          dragDrop: 'Drag & drop an audio file here or click to select',
          selectFile: 'Select Audio File',
          supportedFormats: 'Supports MP3, WAV, AAC, and other audio formats',
        },
        settings: {
          title: 'Video Settings',
          durationPerImage: 'Duration Per Image',
          durationPerImageDesc: 'How long each image should be displayed',
      ...
      messages: {
        ...
        imagesLoaded: '{count} images loaded successfully!',
        audioLoaded: 'Audio loaded successfully!',
        framesExtracted: '{count} frames extracted successfully!',
      ...
      errors: {
        ...
        noValidImages: 'No valid image files were selected.',
        noVideoSelected: 'Please select a video file first.',
        noImagesSelected: 'Please select at least one image file.',
        processingFailed: 'Processing failed',
      },
      tips: {
        title: 'Tips',
        tip1: 'For better results, use videos with consistent lighting and clear scenes',
        tip2: 'When creating videos from images, use images with similar dimensions',
        tip3: 'Adding audio can significantly enhance your video slideshow',
      },
    },
    wsTool: {
      ...
      addressPlaceholder: 'Enter server address without prefix',
      openConnection: 'Open Connection',
      closeConnection: 'Close Connection',
      packetSettings: 'Packet Settings',
      autoSend: 'Auto Send',
      secondsSend: 'seconds send content',
      startSend: 'Start Send',
      stopSend: 'Stop Send',
      manualSend: 'Manual Send',
      sendPlaceholder: 'Content to send to server',
      clearAfterSend: 'Clear after send',
      sendToServer: 'Send to Server',
      debugMessages: 'Debug Messages',
      noDebugMessages: 'No debug messages',
      messageHistory: 'Message History',
      clearMessages: 'Clear Messages',
      clearAfterReceive: 'Clear after receive',
      jsonDecode: 'JSON decode received',
      pauseReceive: 'Pause receive',
      noMessages: 'No messages yet. Connect to a WebSocket server and send a message.',
      sent: 'Sent',
      received: 'Received',
      initSuccess: 'Initialization completed',
      browserNotSupport: 'Current browser does not support H5 WebSocket, please change browser',
      opened: 'OPENED',
      closed: 'CLOSED',
      errorOccurred: 'An error occurred, please open the browser console to view',
      createWsFailed: 'Failed to create WebSocket object, please check the server address',
      loopSend: 'Loop send',
      sendFailed: 'Failed to send message, please check console for details',
    },
    htmlExtractor: {
    ...
    jsonPathExtractor: {
      ...
      syntaxGuide: {
        ...
        rootSymbol: 'Root object or element',
        currentSymbol: 'Current object or element',
        childOperator: 'Child element operator',
        recursiveMatch: 'Recursive match all child elements',
        wildcard: 'Wildcard. Match all objects or elements',
        subscriptOperator: 'Subscript operator, JSONPath indexes start from 0',
        unionOperator:
          'Union operator, combines multiple results into array, JSONPath allows aliases',
        arraySlice: 'Array slice operator',
        filterExpression: 'Filter (script) expression',
        scriptExpression: 'Script expression',
        exampleDesc1: 'Get first book title',
        exampleDesc2: 'Get all book authors',
        exampleDesc3: 'Recursively find all authors',
        exampleDesc4: 'Find books with price less than 10',
        tutorialTitle: 'JSONPath Tutorial',
        tutorialDesc: 'Learn more about JSONPath syntax and usage:',
      },
      inputSection: {
      ...
      quickPaths: {
        ...
        recursiveMatch: 'Recursive match all authors',
        filterExpression: 'Filter books with price < 10',
        unionOperator: 'Union operator for multiple items',
        scriptExpression: 'Script expression for last item',
      },
      success: {
    ...
    jsonNumberToText: {
      title: 'JSON Number to Text Converter',
      description: 'Convert numeric values to text strings in JSON objects and arrays',
      inputTitle: 'Input JSON',
      inputPlaceholder: 'Paste your JSON here...',
      conversionOptions: 'Conversion Options',
      conversionMode: 'Conversion Mode',
      targetFields: 'Target Fields',
      preserveDecimals: 'Preserve Decimal Places',
      decimalPlaces: 'Decimal Places',
      addQuotes: 'Add Quotes Around Numbers',
      convertAll: 'Convert All Numbers',
      specificFields: 'Specific Fields Only',
      integersOnly: 'Integers Only',
      decimalsOnly: 'Decimals Only',
      analysisResults: 'Analysis Results',
      numbersFound: 'Numbers found',
      fieldsToConvert: 'Fields to convert',
      numericFields: 'Numeric fields',
      convertButton: 'Convert Numbers to Text',
      convertedJson: 'Converted JSON',
      conversionComplete: 'Conversion Complete',
      noResults: 'No results yet. Input JSON to convert numbers to text.',
      features: {
        typeConversion: {
          title: 'Type Conversion',
          description: 'Convert numeric values to text while preserving JSON structure',
        },
        selectiveProcessing: {
          title: 'Selective Processing',
          description: 'Choose specific fields or convert all numeric values',
        },
        formatOptions: {
          title: 'Format Options',
          description: 'Control decimal places and number formatting',
        },
      },
      errors: {
        invalidJson: 'Invalid JSON format:',
    ...
    jsonMissingKeyFinder: {
      ...
      description: 'Find missing keys across JSON objects in arrays and detect inconsistencies',
      inputTitle: 'Input JSON Array',
      inputPlaceholder: 'Paste your JSON array here...',
      analysisOptions: 'Analysis Options',
      ignoreNullValues: 'Ignore Null Values',
      deepAnalysis: 'Deep Analysis (Nested Objects)',
      caseSensitive: 'Case Sensitive Key Comparison',
      analyzeButton: 'Analyze Missing Keys',
      analysisResults: 'Analysis Results',
      totalObjects: 'Total objects',
      uniqueKeys: 'Unique keys found',
      objectsWithMissing: 'Objects with missing keys',
      missingKeysReport: 'Missing Keys by Object',
      noResults: 'No analysis yet. Input a JSON array to find missing keys.',
      features: {
        keyAnalysis: {
          title: 'Key Analysis',
          description: 'Analyze all objects to find missing keys and inconsistencies',
        },
        detailedReport: {
          title: 'Detailed Report',
          description: 'Get comprehensive reports on missing keys per object',
        },
        exportResults: {
          title: 'Export Results',
          description: 'Export findings and generate complete object templates',
        },
      },
      errors: {
        invalidJson: 'Invalid JSON format:',
        invalidArray: 'Input must be a JSON array',
      },
    },
    jsonArraySlicer: {
      title: 'JSON Array Slicer',
      description: 'Extract specific portions of JSON arrays using index ranges or conditions',
      inputTitle: 'Input JSON Array',
      inputPlaceholder: 'Paste your JSON array here...',
      slicingOptions: 'Slicing Options',
      method: 'Method',
      indexRange: 'Index Range',
      conditionalFilter: 'Conditional Filter',
      ...
      arrayInfo: 'Array Information',
      totalElements: 'Total elements',
      willExtract: 'Will extract',
      matchingElements: 'Matching elements',
      willSample: 'Will sample',
      sliceButton: 'Slice Array',
      slicedArray: 'Sliced Array',
      noResults: 'No results yet. Input a JSON array to slice.',
      features: {
        indexSlicing: {
          title: 'Index Slicing',
          description: 'Extract array elements by start/end index positions',
        },
        conditionalSlicing: {
          title: 'Conditional Slicing',
          description: 'Filter elements based on field values and conditions',
        },
        smartPreview: {
          title: 'Smart Preview',
          description: 'Preview sliced results with detailed statistics',
        },
      },
      errors: {
        invalidJson: 'Invalid JSON format:',
    ...
    unifiedExcelToJson: {
      title: 'Excel to JSON Converter',
      description: 'Convert Excel files and text data to JSON format',
      modes: {
        file: 'File Mode',
        text: 'Text Mode',
      },
    ...
    jsonArrayDeduplicator: {
      ...
      description: 'Remove duplicate elements from JSON arrays with various comparison methods',
      inputTitle: 'Input JSON Array',
      inputPlaceholder: 'Paste your JSON array here...',
      deduplicationOptions: 'Deduplication Options',
      comparisonMethod: 'Comparison Method',
      compareField: 'Compare Field',
      keepOccurrence: 'Keep Occurrence',
      caseSensitive: 'Case Sensitive Comparison',
      showDuplicates: 'Show Found Duplicates',
      deepComparison: 'Deep Comparison (Entire Object)',
      shallowComparison: 'Shallow Comparison (Reference)',
      fieldComparison: 'Specific Field Comparison',
      stringComparison: 'JSON String Comparison',
      ...
      deduplicateButton: 'Remove Duplicates',
      deduplicatedArray: 'Deduplicated Array',
      deduplicationComplete: 'Deduplication Complete',
      noResults: 'No results yet. Input a JSON array to remove duplicates.',
      features: {
        smartDetection: {
          title: 'Smart Detection',
          description: 'Detect duplicates using deep comparison or specific field matching',
        },
        flexibleOptions: {
          title: 'Flexible Options',
          description: 'Choose comparison methods and specify which occurrence to keep',
        },
        detailedStats: {
          title: 'Detailed Stats',
          description: 'Get comprehensive statistics about duplicates found and removed',
        },
      },
      errors: {
        invalidJson: 'Invalid JSON format:',
    ...
    colorPicker: {
      ...
      clickToPick: 'Click on the image to pick a color',
      keepPickingUntilCancel: 'Keep picking colors until you click Cancel Pick',
      commonColors: 'Common Colors',
      conversions: 'Color Conversions',
      preview: 'Preview',
      onLight: 'On Light Background',
      ...
      invalidRgba: 'Invalid RGBA color format',
      invalidRgbaRange: 'RGBA values must be between 0-255 for colors and 0-1 for alpha',
      invalidHsl: 'Invalid HSL color format',
      invalidHslRange: 'HSL values must be H: 0-360, S: 0-100%, L: 0-100%',
      invalidHsv: 'Invalid HSV color format',
      invalidHsvRange: 'HSV values must be H: 0-360, S: 0-100%, V: 0-100%',
      invalidCmyk: 'Invalid CMYK color format',
      invalidCmykRange: 'CMYK values must be between 0-100%',
      hexPlaceholder: 'Enter HEX color (#RRGGBB)',
      features: {
        title: 'Key Features',
        conversions: {
          title: 'Multiple Format Support',
          description:
            'Convert between HEX, RGB, RGBA, HSL, HSV, and CMYK color formats with real-time updates',
        },
        imagePicker: {
          title: 'Image Color Extraction',
          description: 'Upload an image and click anywhere to extract exact colors from the image',
        },
        commonColors: {
          title: 'Common Color Palette',
          description: 'Quickly select from a palette of commonly used colors',
        },
      },
    },
    pdfViewer: {
      title: 'PDF Viewer',
      description: 'Preview and basic editing of PDF documents',
      uploadSection: 'Upload PDF',
      uploadTitle: 'Upload PDF File',
      uploadDescription: 'Drag and drop your PDF file here or click to browse',
      supportedFormats: 'Supported formats',
      selectPdf: 'Select PDF File',
      preview: 'PDF Preview',
      download: 'Download PDF',
      selectAnother: 'Select Another PDF',
    ...
    jwtTool: {
      title: 'JWT Tool',
      description: 'Encode, decode, and verify JSON Web Tokens with customizable algorithms',
      encodeTab: 'Encode',
      decodeTab: 'Decode',
      verifyTab: 'Verify',
      features: {
        encode: {
          ...
          description: 'Create JWT tokens with custom headers, payloads, and signing secrets',
        },
        decode: {
          title: 'Token Decoding',
          description: 'Decode JWT tokens to view header and payload information with validation',
        },
        verify: {
          title: 'Signature Verification',
          description: 'Verify the signature of JWT tokens to ensure authenticity and integrity',
        },
      },
      encode: {
        header: 'Header',
      ...
      verify: {
        ...
        tokenPlaceholder: 'Paste your JWT token here...',
        secret: 'Secret',
        secretPlaceholder: 'Enter the secret used to sign the token',
      ...
      messages: {
        ...
        tokenDownloaded: 'Token downloaded successfully!',
        validToken: 'Valid token signature',
        expiredToken: 'Token has expired',
        notBeforeToken: 'Token is not yet valid',
      ...
      errors: {
        ...
        invalidToken: 'Invalid token format',
        invalidJson: 'Invalid JSON format',
        missingSecret: 'Please provide a secret for verification',
        verifyFailed: 'Failed to verify signature',
      },
    },
    transformTools: {
      title: 'Transform Tools',
      description: 'Online tools for code formatting, minification, and conversion',
      editor: 'Transform Editor',
      loading: 'Loading transform.tools...',
      note: 'Note: This tool loads an external website. Some features may require an internet connection.',
      footer: '💡 Tip: This tool runs in an iframe and does not upload your data to any server',
      features: {
        '1': 'Code formatting and beautification',

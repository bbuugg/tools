export default {
  ...
  tools: {
    ...
    webRtcChatRoom: {
      title: 'WebRTC Chat Room',
      description: 'Real-time chat room with video, audio, and file sharing capabilities',
      userName: 'Your Name',
      ...
      room: {
        ...
        leave: 'Leave',
        you: 'You',
        created: 'Room created with ID: {roomId}',
        joined: 'Joined room: {roomId}',
        left: 'Left room',
        error: 'Room error: {error}',
        participantJoined: 'Participant joined: {id}',
        participantLeft: 'Participant left: {id}',
      },
      participants: {
        title: 'Participants',
        online: 'Online',
      ...
      video: {
        ...
        remoteVideos: 'Participants',
        noRemoteVideo: 'No remote video streams',
      },
      controls: {
        camera: 'Camera',
      ...
      chat: {
        ...
        roomJoined: 'Joined room: {roomId}',
        participantJoined: '{name} joined the room',
        participantLeft: '{name} left the room',
        fileReceived: 'File received: {fileName}',
        fileSent: 'File sent: {fileName}',
      },
      logs: {
        title: 'Debug Logs',
        showLogs: 'Show Debug Logs',
      },
    },
    webRtcMeeting: {
      title: 'WebRTC Meeting',
      subtitle: 'Professional video conferencing with real-time collaboration',
      ...
      meeting: {
        ...
        created: 'Meeting created with ID: {meetingId}',
        joined: 'Joined meeting: {meetingId}',
        left: 'Left meeting',
        error: 'Meeting error: {error}',
      },
      participants: {
        title: 'Participants',
        count: 'participants',
      ...
      chat: {
        ...
        sendFile: 'Send File',
        download: 'Download',
        meetingCreated: 'Meeting created: {meetingId}',
        meetingJoined: 'Joined meeting: {meetingId}',
      ...
      av: {
        ...
        localVideo: 'Your Camera',
        remoteVideos: 'Participants',
        noRemoteVideo: 'No one else in the room',
        ...
        localStreamError: 'Failed to start local stream: {error}',
      ...
      logs: {
        ...
        connectionTimeout: 'Connection timeout, resetting connection',
        connectionReset: 'Connection reset to initial state',
        acceptingConnection: 'Accepting connection from device {id}',
        connectionRequestRejected: 'Connection request rejected from device {id}',
      },
    },
    textSteganography: {

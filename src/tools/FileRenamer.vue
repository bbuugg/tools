          ...
          <div v-if="activeTab === 'script'">
            <div class="space-y-6">
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="flex items-center justify-center">
                  <div class="text-sm text-gray-500">
                    {{ $t('tools.fileRenamer.script.autoGenerated') }}
                  </div>
                </div>
              </div>
              ...
              <div class="border rounded-lg overflow-hidden">
                ...
                <div
                  class="bg-gray-800 text-green-400 p-4 font-mono text-sm overflow-x-auto max-h-96"
                >
...
const sortFiles = (type: string) => {
  ...
  switch (type) {
    ...
    case 'modifiedTimeDesc':
      ...
      files.value.sort((a, b) => b.lastModified - a.lastModified)
      break
    case 'random':
      // Random sort

  ...
  <div class="grid lg:grid-cols-2 gap-6">
    ...
    <div class="glass rounded-xl border border-slate-700/30 p-6">
      ...
      >
        ...
        <p class="text-sm text-slate-400 mt-2">{{ $t('tools.excelToJson.supportedFormats') }}</p>
      </div>
      ...
      <div class="space-y-4">
        ...
        <div class="grid grid-cols-2 gap-4">
          <label class="flex items-center text-slate-300 hover:text-slate-100 transition-colors">
            <input

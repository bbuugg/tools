  ...
  <div class="min-h-screen bg-gray-50 p-6">
    <div class="max-w-4xl mx-auto space-y-6">
      <div class="text-center mb-8">
        <h1 class="text-3xl font-bold text-gray-900 mb-2">GET Parameters to JSON</h1>
        <p class="text-gray-600">Convert URL query parameters to JSON format</p>
      </div>
      <div class="bg-white p-8 rounded-lg shadow-sm border text-center">
        ...
        <div class="flex justify-center space-x-4">
          ...
          <button
            @click="$router.push('/json-tools/json-formatter')"

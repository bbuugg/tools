    ...
    <div class="max-w-4xl mx-auto space-y-6">
      ...
      <div class="bg-white p-8 rounded-lg shadow-sm border text-center">
        ...
        <p class="text-gray-600 mb-6">
          This JSON tool is currently being developed and will be available soon. 
...
const toolConfig: Record<string, any> = {
  'excel-text-to-json': {
    ...
    features: ['Paste Excel data directly', 'Auto-detect data types', 'Header recognition', 'Real-time conversion']
  },
  'json-merge': {
    title: 'JSON File Merger',
    description: 'Merge multiple JSON files into a single file',
    features: ['Merge multiple files', 'Conflict resolution', 'Deep merging', 'Custom merge strategies']
  },
  'get-to-json': {
    title: 'GET Parameters to JSON',
    description: 'Convert URL query parameters to JSON format',
    features: ['URL parsing', 'Parameter extraction', 'Type conversion', 'Nested parameter support']
  },
  'cookie-to-json': {
    title: 'Cookie to JSON',
    description: 'Convert cookie strings to JSON objects',
    features: ['Cookie string parsing', 'Automatic decoding', 'Expiry date handling', 'Secure flag detection']
  },
  'list-to-json': {
  ...
  'header-to-json': {
    ...
    features: ['Header parsing', 'Case handling', 'Multi-value support', 'Standard header recognition']
  },
  'json-splitter': {
    title: 'JSON File Splitter',
    description: 'Split large JSON files into smaller chunks',
    features: ['Size-based splitting', 'Record-based splitting', 'Preserve structure', 'Custom naming']
  },
  'json-to-list': {
  ...
  'json-to-get': {
    ...
    features: ['URL encoding', 'Nested object handling', 'Array serialization', 'Custom formatting']
  },
  'json-field-value-extractor': {
    title: 'JSON Field Value Extractor',
    description: 'Extract values from specific JSON fields',
    features: ['Path-based extraction', 'Bulk value extraction', 'Type filtering', 'Duplicate removal']
  },
  'json-unicode-fixer': {
    title: 'JSON Unicode Fixer',
    description: 'Fix Unicode encoding issues in JSON',
    features: ['Unicode normalization', 'Encoding detection', 'Character replacement', 'Validation']
  },
  'json-number-to-text': {
    title: 'JSON Number to Text',
    description: 'Convert numeric values to text in JSON',
    features: ['Type conversion', 'Precision handling', 'Formatting options', 'Selective conversion']
  }
}

const config = computed(() => {
  const routeName = route.name as string
  return toolConfig[routeName] || {
    title: 'JSON Tool',

              ...
              <div class="space-y-2">
                ...
                <div class="flex gap-4 items-center">
                  <div class="flex items-center gap-2">
                    ...
                    >
                    <input
                      v-model.number="timeRange.start"
                      type="number"
                      min="0"
                      :max="videoDuration"
                      step="0.1"
...
function onVideoLoaded() {
  if (videoPlayer.value) {
    ...
    timeRange.end = Math.min(videoDuration.value, 15) // Limit to 15 seconds by default
  }
}
...
async function generateGif() {
  ...
  try {
    ...
    alert(t('tools.videoToGifConverter.errors.processingFailed'))
  } finally {
...
async function createGifFromVideo() {
  ...
  for (
    ...
    try {
      ...
      console.error('Error processing frame at time:', time, error)
    }
  }

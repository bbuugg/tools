...
import { CodeOutlined, CopyOutlined, EditOutlined } from "@ant-design/icons";
...
const tools: ToolConfig[] = [
  ...
  },
  {
    id: "jsonEditor",
    name: "JSON Editor",
    description: "Interactive JSON editor with syntax highlighting",
    icon: <EditOutlined />,
    category: "Text",
    component: React.lazy(() => import("./JsonEditor")),
    path: "/json/editor",
  },
  {
    id: "jsonConverter",

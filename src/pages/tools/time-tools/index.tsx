  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex items-center gap-2 text-sm text-gray-500">
        ...
        <code className="rounded bg-gray-100 px-2 py-0.5 font-mono text-primary">
          {nowTs}
        </code>
      </div>
        ...
        <div className="space-y-3 rounded-lg border border-gray-200 bg-white p-5">
          ...
          <div className="flex items-center gap-2">
            <div className="inline-flex rounded-md border border-gray-200 p-0.5">
              <button
                className={cn("rounded px-3 py-1 text-xs font-medium transition-colors", unit === "s" ? "bg-primary text-white" : "text-gray-600 hover:bg-gray-100")}
                onClick={() => { setUnit("s"); if (timestamp) tsToDt(timestamp, "s"); }}
              >秒 (10位)</button>
              <button
                className={cn("rounded px-3 py-1 text-xs font-medium transition-colors", unit === "ms" ? "bg-primary text-white" : "text-gray-600 hover:bg-gray-100")}
          ...
          {timestamp && (
            <div className="flex items-center justify-between gap-2">
              <code className="flex-1 truncate rounded bg-gray-100 px-3 py-2 text-sm">
                {timestamp}
              </code>
      ...
      <div className="rounded-lg bg-gray-50 p-4 text-sm text-gray-500">
        <p className="mb-2 font-medium text-gray-700">使用说明</p>
      ...
      <div className="inline-flex rounded-lg border border-gray-200 bg-white p-1">
        <button
          className={cn(
            ...
            mode === "diff" ? "bg-primary text-white" : "text-gray-600 hover:bg-gray-100",
          )}
        ...
        <button
          className={cn(
            "rounded-md px-4 py-1.5 text-sm font-medium transition-colors",
            mode === "add" ? "bg-primary text-white" : "text-gray-600 hover:bg-gray-100",
          )}
          onClick={() => setMode("add")}
        >
          日期加减
      ...
      <div className="rounded-lg border border-gray-200 bg-white p-5">
        ...
        <div className="space-y-3">
          {TIMEZONE_GROUPS.map((group) => (
            <div key={group.name}>
              <p className="mb-1.5 text-xs font-medium text-gray-400">{group.name}</p>
              <div className="space-y-1">

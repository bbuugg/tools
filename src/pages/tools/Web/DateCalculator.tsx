...
const DateCalculator: React.FC = () => {
  ...
  // 计算日期差值
  const calculateDateDiff = (start: dayjs.Dayjs | null, end: dayjs.Dayjs | null) => {
    if (!start || !end) return;
    ...
    try {
      ...
      console.error(intl.formatMessage({ id: 'tools.dateCalculator.error.calculation_error' }), error);
    }
  };

  // 计算日期加减
  const calculateDateAddition = (base: dayjs.Dayjs | null, amount: number, unit: TimeUnit, op: 'add' | 'subtract') => {
  ...
  const renderUnitSelector = () => {
    const units = [
      { value: TimeUnit.YEARS, label: intl.formatMessage({ id: 'tools.dateCalculator.diff_calculator.year_unit' }) },
      { value: TimeUnit.MONTHS, label: intl.formatMessage({ id: 'tools.dateCalculator.diff_calculator.month_unit' }) },
      { value: TimeUnit.WEEKS, label: intl.formatMessage({ id: 'tools.dateCalculator.diff_calculator.week_unit' }) },
      { value: TimeUnit.DAYS, label: intl.formatMessage({ id: 'tools.dateCalculator.diff_calculator.day_unit' }) },
      { value: TimeUnit.HOURS, label: intl.formatMessage({ id: 'tools.dateCalculator.diff_calculator.hour_unit' }) },
      { value: TimeUnit.MINUTES, label: intl.formatMessage({ id: 'tools.dateCalculator.diff_calculator.minute_unit' }) },
    ];
            ...
            children: (
              <Card>
                ...
                <Row gutter={[24, 24]}>
                  <Col xs={24} md={12}>
                    <div className="space-y-6">
                      ...
                      <div className="flex justify-center">
                        <Button onClick={swapDates} className="flex items-center">
                  ...
                  <Col xs={24} md={12}>
                    <Card title={<FormattedMessage id="tools.dateCalculator.diff_calculator.result_title" />}>
                      {Object.keys(diffResult).length > 0 ? (
                        <div className="space-y-2">
                          <div className="flex justify-between items-center py-2 border-b border-gray-200 dark:border-gray-700">
                            ...
                            <div className="flex items-center gap-2">
                              <Text strong>
                                {diffResult.years} <FormattedMessage id="tools.dateCalculator.diff_calculator.year_unit" />
                              </Text>
                              <Button
                                size="small"
                                icon={copied === 'years' ? <CheckOutlined /> : <CopyOutlined />}
                          ...
                          <div className="flex justify-between items-center py-2 border-b border-gray-200 dark:border-gray-700">
                            ...
                            <div className="flex items-center gap-2">
                              <Text strong>
                                {diffResult.months} <FormattedMessage id="tools.dateCalculator.diff_calculator.month_unit" />
                              </Text>
                              <Button
                                size="small"
                                icon={copied === 'months' ? <CheckOutlined /> : <CopyOutlined />}
                          ...
                          <div className="flex justify-between items-center py-2 border-b border-gray-200 dark:border-gray-700">
                            ...
                            <div className="flex items-center gap-2">
                              <Text strong>
                                {diffResult.weeks} <FormattedMessage id="tools.dateCalculator.diff_calculator.week_unit" />
                              </Text>
                              <Button
                                size="small"
                                icon={copied === 'weeks' ? <CheckOutlined /> : <CopyOutlined />}
                          ...
                          <div className="flex justify-between items-center py-2 border-b border-gray-200 dark:border-gray-700">
                            ...
                            <div className="flex items-center gap-2">
                              <Text strong>
                                {diffResult.days} <FormattedMessage id="tools.dateCalculator.diff_calculator.day_unit" />
                              </Text>
                              <Button
                                size="small"
                                icon={copied === 'days' ? <CheckOutlined /> : <CopyOutlined />}
                          ...
                          <div className="flex justify-between items-center py-2 border-b border-gray-200 dark:border-gray-700">
                            ...
                            <div className="flex items-center gap-2">
                              <Text strong>
                                {diffResult.hours} <FormattedMessage id="tools.dateCalculator.diff_calculator.hour_unit" />
                              </Text>
                              <Button
                                size="small"
                                icon={copied === 'hours' ? <CheckOutlined /> : <CopyOutlined />}
                          ...
                          <div className="flex justify-between items-center py-2 border-b border-gray-200 dark:border-gray-700">
                            ...
                            <div className="flex items-center gap-2">
                              <Text strong>
                                {diffResult.minutes} <FormattedMessage id="tools.dateCalculator.diff_calculator.minute_unit" />
                              </Text>
                              <Button
                                size="small"
                                icon={copied === 'minutes' ? <CheckOutlined /> : <CopyOutlined />}
                          ...
                          <div className="flex justify-between items-center py-2 border-b border-gray-200 dark:border-gray-700">
                            ...
                            <div className="flex items-center gap-2">
                              <Text strong>
                                {diffResult.seconds} <FormattedMessage id="tools.dateCalculator.diff_calculator.second_unit" />
                              </Text>
                              <Button
                                size="small"
                                icon={copied === 'seconds' ? <CheckOutlined /> : <CopyOutlined />}
            ...
            children: (
              <Card>
                ...
                <Row gutter={[24, 24]}>
                    ...
                    <div className="space-y-6">
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <Button
                            type={operation === 'subtract' ? 'primary' : 'default'}
                            icon={<MinusOutlined />}
                      ...
                      <div>
                        ...
                        <Input
                          ...
                          min="1"
                          value={timeAmount}
                          onChange={(e) => handleTimeAmountChange(parseInt(e.target.value) || 1)}
                          className="w-full"
                        />
                      </div>
                  ...
                  <Col xs={24} md={12}>
                    <Card title={<FormattedMessage id="tools.dateCalculator.add_calculator.result_title" />}>
                      {addResult ? (
                        <div className="space-y-4">
                          <div className="p-4 bg-gray-100 dark:bg-gray-800 rounded-md text-center">
                            <Text type="secondary" className="text-sm block mb-1">
                              {operation === 'add' 
                                ? intl.formatMessage({ id: 'tools.dateCalculator.add_calculator.add_result' })
                                    .replace('{amount}', timeAmount.toString())
                                    .replace('{unit}', 
                                      timeUnit === TimeUnit.YEARS ? intl.formatMessage({ id: 'tools.dateCalculator.diff_calculator.year_unit' }) : 
                                      timeUnit === TimeUnit.MONTHS ? intl.formatMessage({ id: 'tools.dateCalculator.diff_calculator.month_unit' }) : 
                                      timeUnit === TimeUnit.WEEKS ? intl.formatMessage({ id: 'tools.dateCalculator.diff_calculator.week_unit' }) : 
                                      timeUnit === TimeUnit.DAYS ? intl.formatMessage({ id: 'tools.dateCalculator.diff_calculator.day_unit' }) : 
                                      timeUnit === TimeUnit.HOURS ? intl.formatMessage({ id: 'tools.dateCalculator.diff_calculator.hour_unit' }) : 
                                      intl.formatMessage({ id: 'tools.dateCalculator.diff_calculator.minute_unit' }))
                                : intl.formatMessage({ id: 'tools.dateCalculator.add_calculator.subtract_result' })
                                    .replace('{amount}', timeAmount.toString())
                                    .replace('{unit}', 
                                      timeUnit === TimeUnit.YEARS ? intl.formatMessage({ id: 'tools.dateCalculator.diff_calculator.year_unit' }) : 
                                      timeUnit === TimeUnit.MONTHS ? intl.formatMessage({ id: 'tools.dateCalculator.diff_calculator.month_unit' }) : 
                          ...
                          <div className="flex justify-center">
                            <Button
                              icon={copied === 'result' ? <CheckOutlined /> : <CopyOutlined />}
                    ...
                    <div>
                      ...
                      <ul className="list-disc pl-5 space-y-1 text-sm text-gray-600 dark:text-gray-400">
                        <li><FormattedMessage id="tools.dateCalculator.add_calculator.note1" /></li>
                        <li><FormattedMessage id="tools.dateCalculator.add_calculator.note2" /></li>
                        <li><FormattedMessage id="tools.dateCalculator.add_calculator.note3" /></li>
                      </ul>
                    </div>
                  </Col>
                </Row>

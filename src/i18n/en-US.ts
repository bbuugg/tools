export default {
  ...
  // JSON Editor
  "tools.jsonEditor.name": "JSON Editor",
  "tools.jsonEditor.description":
    "Interactive JSON editor with syntax highlighting.",
  "tools.jsonEditor.editor_title": "JSON Editor",
  "tools.jsonEditor.edit_json_here": "Edit your JSON here...",
  "tools.jsonEditor.copy": "Copy",
  "tools.jsonEditor.download": "Download",
  "tools.jsonEditor.upload": "Upload",
  "tools.jsonEditor.clear": "Clear",
  "tools.jsonEditor.file_name": "File Name:",
  "tools.jsonEditor.copied_to_clipboard": "Copied to clipboard!",
  "tools.jsonEditor.download_success": "Download started for {fileName}",
  "tools.jsonEditor.download_failed": "Download failed",
  "tools.jsonEditor.copy_failed": "Copy failed",
  "tools.jsonEditor.loaded_file": "Loaded file: {fileName}",
  "tools.jsonEditor.loaded_as_text": "Loaded as text: {fileName}",
  "tools.jsonEditor.read_file_failed": "Failed to read file",
  "tools.jsonEditor.confirm_clear":
    "Are you sure you want to clear the editor?",
  "tools.jsonEditor.editor_cleared": "Editor cleared",
  "tools.jsonEditor.invalid_json": "Invalid JSON",
  ...
  // Encoding Converter
  "tools.encodingConverter.name": "Encoding Converter",
  "tools.encodingConverter.description":
    "Convert text between different encoding formats (Base64, URL, Unicode, HTML entities, etc.).",
  "tools.encodingConverter.select_type": "Select Encoding Type",
  "tools.encodingConverter.types.base64": "Base64",
  "tools.encodingConverter.types.url": "URL",
  "tools.encodingConverter.types.unicode": "Unicode",
  "tools.encodingConverter.types.html_entity": "HTML Entity",
  "tools.encodingConverter.types.html_escape": "HTML Escape",
  "tools.encodingConverter.base64_desc": "Binary-to-text encoding",
  "tools.encodingConverter.url_desc": "URL percent encoding",
  "tools.encodingConverter.unicode_desc": "Unicode escape sequences",
  "tools.encodingConverter.html_entity_desc": "HTML hexadecimal entities",
  "tools.encodingConverter.html_escape_desc": "HTML character escaping",
  "tools.encodingConverter.encode": "Encode",
  "tools.encodingConverter.decode": "Decode",
  "tools.encodingConverter.text_to_encode": "Text to Encode",
  "tools.encodingConverter.text_to_decode": "Text to Decode",
  "tools.encodingConverter.encoded_result": "Encoded Result",
  "tools.encodingConverter.decoded_result": "Decoded Result",
  "tools.encodingConverter.input_placeholder": "Enter text to convert...",
  "tools.encodingConverter.output_placeholder":
    "Converted text will appear here...",
  "tools.encodingConverter.copy": "Copy",
  "tools.encodingConverter.load_example": "Load Example",
  "tools.encodingConverter.example": "Example",
  "tools.encodingConverter.clear_all": "Clear All",
  "tools.encodingConverter.swap_operation": "Swap Operation",
  "tools.encodingConverter.general_error":
    "An error occurred during conversion",
  "tools.encodingConverter.unsupported_type": "Unsupported encoding type",
  "tools.encodingConverter.invalid_base64": "Invalid Base64 string",
  "tools.encodingConverter.invalid_url": "Invalid URL encoded string",
  "tools.encodingConverter.invalid_unicode": "Invalid Unicode sequence",
  "tools.encodingConverter.invalid_html_entity": "Invalid HTML entity",
  "tools.encodingConverter.invalid_html_escape": "Invalid HTML escape sequence",
  "tools.encodingConverter.example_text": "Hello, World!",
  "tools.encodingConverter.hello": "Hello",
  "tools.encodingConverter.html_example": "HTML Example",
  "tools.encodingConverter.encoding_info": "Encoding Information",
  "tools.encodingConverter.info.base64":
    "Base64 is a binary-to-text encoding scheme that represents binary data in an ASCII string format.",
  "tools.encodingConverter.info.url":
    "URL encoding converts characters into a format that can be transmitted over the Internet.",
  "tools.encodingConverter.info.unicode":
    "Unicode encoding uses \\u prefix followed by four hexadecimal digits to represent characters.",
  "tools.encodingConverter.info.html_entity":
    "HTML entity encoding uses hexadecimal format (e.g. &#x6C49;) to represent Unicode characters.",
  "tools.encodingConverter.info.html_escape":
    "HTML escaping converts special characters like <, >, & into HTML entities to prevent interpretation as HTML.",

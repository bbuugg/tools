export default {
  ...
  "home.noResultsDesc": "Try searching with different keywords",
  ...
  "tools.universalVideoPlayer.mixedContentError": "Cannot play HTTP stream on an HTTPS page — the browser blocks mixed content. Workarounds: (1) Open the URL in a local HTTP page, or (2) Set up an HTTPS reverse proxy for the stream.",

...
| # | 工具名称 | 描述 | URL |
|---|---------|------|-----|
| 1 | Excel 转 JSON | 将 Excel/CSV 文件或表格文本快速转换为 JSON，支持表头识别、类型推断和多种输出格式 | <https://tools.codeemo.cn/tools/excel2json> |
| 2 | 批量文件重命名 | 序号、替换、大小写、插入、截取等多种重命名方式，支持生成重命名脚本 | <https://tools.codeemo.cn/tools/file-renamer> |
...
| # | 工具名称 | 描述 | URL |
|---|---------|------|-----|
| 1 | 微信聊天模拟 | 在线制作微信聊天截图，支持自定义头像、昵称、消息内容、红包、时间等，实时预览并导出图片 | <https://tools.codeemo.cn/tools/wechat-chat> |
